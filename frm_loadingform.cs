...
{
    public partial class frm_loadingform : Form
    {
        public frm_loadingform()
        {
            InitializeComponent();
        ...
        public frm_loadingform(Form parent)
        {
            InitializeComponent();
            if (parent != null)
            {
        ...
        private void frm_loadingform_Load(object sender, EventArgs e)
        {
            this.Opacity = 0;
            tfade.Interval = 10;
        ...
        private void frm_loadingform_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
