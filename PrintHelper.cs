...
namespace EMB_ERM_Sub_Sytem_Laboratory_Unit
{
    ...
    class PrintHelper
    {
        ...
        public PrintHelper(String userbasepath, String userlogname)
        {
    ...
    class LogWriter
    {
        ...
        /// <param name="name"></param>
        public static void Write(String from, PrintHelper.Categories category, String msg, String path, String name)
        {
    ...
    public class DGVPrinter
    {
        ...
        public Boolean EnableLogging
        {
            ...
            set
            {
                ...
                if (enablelogging)
                {
                    Logger = new PrintHelper(".", "DGVPrinter");
                }
            }
        }
